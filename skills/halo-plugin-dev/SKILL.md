...
| [references/theme-integration.md](references/theme-integration.md)     | Finder API for themes, template variables, reverse proxy, static resources                    | Integrating with theme frontend           |
